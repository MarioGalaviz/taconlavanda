    ...
    return(
        <div>
            ...
            <Grid container justifyContent='center'>
                ...
                <Typography variant='body1' sx={{ my: 1.8}} width={'100%'} align='justify'>Mario Alberto Galaviz García mejor conocido como Taconlavanda, con domicilio en Turmalina 376, Colinas de San Javier, Lagos de Moreno, Jalisco, México y portal de internet www.taconlavanda.com, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:</Typography>
